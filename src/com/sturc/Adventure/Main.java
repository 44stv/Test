...
/*            String[] directionArray = scanner.nextLine().split("");
            String[] availableDirections = {"N", "W", "S" , "E"};
            String direction = null;

            for (String direct : directionArray){
                for (String availdir : availableDirections){
                    if (direct.equals(availdir)) {
                        direction = availdir;
                    }
                }
            }*/
